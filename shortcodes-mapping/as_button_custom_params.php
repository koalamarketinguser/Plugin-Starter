 ...
 *
 */
function as_button_custom_array() {
...
function vc_ase_map_as_custom_button() {
	vc_map(
		array(
			'name'        => __( 'Button', 'vc_ase' ),
			'base'        => 'as_custom_button',
			'class'       => '',
			'weight'      => 1,
			'icon'        => 'as_custom_button',
			...
			'params'      => array_merge( apply_filters( 'head_param_array', '' ), as_button_custom_array() ),

		)
	); // end vc_map()
}
add_action( 'init', 'vc_ase_map_as_custom_button' );
