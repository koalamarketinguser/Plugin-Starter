...
function vc_ase_admin_init() {
	...
	if ( VC_IS_ACTIVE ) {
		...
		//luxury shortcode paramaters
		include VC_ASE_DIR . 'shortcodes-mapping/as_luxury_slider_params.php';
		include VC_ASE_DIR . 'shortcodes-mapping/as_luxury_testimonials_slider_params.php';




		include VC_ASE_DIR . 'shortcodes-mapping/as_house_gallery_short_params.php';     // AJAXED CONTENT.
        include VC_ASE_DIR . 'shortcodes-mapping/as_house_important_info_params.php';     // AJAXED CONTENT.
        include VC_ASE_DIR . 'shortcodes-mapping/as_house_payments_params.php';     // AJAXED CONTENT.
        include VC_ASE_DIR . 'shortcodes-mapping/as_house_gallery_params.php';     // AJAXED CONTENT.
		include VC_ASE_DIR . 'shortcodes-mapping/as_short_house_info_params.php';     // AJAXED CONTENT.
        include VC_ASE_DIR . 'shortcodes-mapping/as_link_title_params.php';     // AJAXED CONTENT.
		include VC_ASE_DIR . 'shortcodes-mapping/as_houses_slider_params.php';     // AJAXED CONTENT.
        include VC_ASE_DIR . 'shortcodes-mapping/as_icon_text_params.php';     // AJAXED CONTENT.
        include VC_ASE_DIR . 'shortcodes-mapping/as_custom_header_params.php';     // AJAXED CONTENT.
		include VC_ASE_DIR . 'shortcodes-mapping/as_localization_info_params.php';     // AJAXED CONTENT.
		include VC_ASE_DIR . 'shortcodes-mapping/as_localization_slider_params.php';     // AJAXED CONTENT.
        include VC_ASE_DIR . 'shortcodes-mapping/as_text_image_params.php';     // AJAXED CONTENT.
		...
		include VC_ASE_DIR . 'shortcodes-mapping/as_button_params.php';
		include VC_ASE_DIR . 'shortcodes-mapping/as_button_custom_params.php';       // BUTTON.
...
function vc_ase_init() {
	...
	if ( VC_IS_ACTIVE ) {
		...
		//luxury shortcode paramaters
		include VC_ASE_DIR . 'shortcodes/as_luxury_slider.php';
		include VC_ASE_DIR . 'shortcodes/as_luxury_testimonials_slider.php';
		...
		include VC_ASE_DIR . 'shortcodes/short-house-info.php';
        include VC_ASE_DIR . 'shortcodes/as_link_title.php';
		include VC_ASE_DIR . 'shortcodes/as_houses_slider.php';
        include VC_ASE_DIR . 'shortcodes/as_icon_text.php';
        include VC_ASE_DIR . 'shortcodes/as_custom_header.php';     // AJAXED CONTENT.
		include VC_ASE_DIR . 'shortcodes/as_localization_info.php';     // AJAXED CONTENT.
		...
		include VC_ASE_DIR . 'shortcodes/as_button.php'; 
		include VC_ASE_DIR . 'shortcodes/as_button_custom.php'; 
		include VC_ASE_DIR . 'shortcodes/text_image.php';        // BUTTON.
        // include VC_ASE_DIR . 'shortcodes/localization_slider.php';        // BUTTON.
