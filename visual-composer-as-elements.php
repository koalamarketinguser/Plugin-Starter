...
class AS_VC_ELEMENTS {
	...
	public function vc_ase_styles() {
		...
		// wp_enqueue_style( 'vc-ase-font-awesome' );
		 ...
		 wp_register_style( 'vc-ase-styles', VC_ASE_URL . 'assets/css/main.css', array(), null ,'all' );
		 wp_enqueue_style( 'vc-ase-styles' );
		 wp_register_style( 'vc-ase-owl-styles', VC_ASE_URL . 'assets/owl/assets/owl.carousel.min.css' );
		 wp_enqueue_style( 'vc-ase-owl-styles' );
	...
	public function vc_ase_scripts() {
		...
		// JS scripts.
		wp_register_script( 'vc-ase-ajax-js', VC_ASE_URL . 'assets/js/compiled/main.js' );
		wp_enqueue_script( 'vc-ase-ajax-js', VC_ASE_URL . 'assets/js/compiled/main.js', array( 'jQuery', 'wc-single-product' ), '1.0', true );

		wp_register_script( 'vc-ase-owl-js', VC_ASE_URL . 'assets/owl/owl.carousel.js' );
		wp_enqueue_script( 'vc-ase-owl-js', VC_ASE_URL . 'assets/owl/owl.carousel.js', array( 'jQuery', 'wc-single-product' ), '1.0', true );
